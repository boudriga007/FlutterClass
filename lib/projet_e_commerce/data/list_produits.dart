...
class AllProductData {
  final List<Produit> _produits = [
    ...
    Produit(
      ...
      brand: 'No brand',
      produitCategoryName: 'Beauty & health',
      quantity: 8515,
    ),
    Produit(
